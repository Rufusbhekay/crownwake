...
const required = [
  ...
  "vendor/three.module.js", "vendor/three.core.js", "vendor/loaders/GLTFLoader.js", "vendor/utils/BufferGeometryUtils.js", "src/sim.js", "sim-runtime-20260725c.js", "design/plan.md", "design/gameplay-glossary.md",
...
const runtimeSimulationSource = await readFile(resolve(root, "sim-runtime-20260725c.js"), "utf8");
...
if (!gameSource.includes('from "./sim-runtime-20260725c.js"')) {
