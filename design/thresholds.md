...
- Character facing: direction is communicated through controlled body orientation without added arrows, panels, or black front markers. Travel and commander flanking use movement-facing at 3.6 radians/second; committed soldier duels and commanders within 2.2 units of their opponent use opponent-facing at 4.6–5.2 radians/second. Corrections below 0.055 radians are ignored, and only one rotation source owns an actor per frame.
